...
class QMapboxGLMapObserverPrivate : public QObject, public mbgl::MapObserver
{
    Q_OBJECT

public:
    explicit QMapboxGLMapObserverPrivate(QMapboxGLPrivate *);
    virtual ~QMapboxGLMapObserverPrivate();
...
private:
    Q_DISABLE_COPY(QMapboxGLMapObserverPrivate)
